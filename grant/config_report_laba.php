...
$gl_sql_report = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) join gl_distributor on(gl_buku.id_distributor=gl_distributor.id_distributor) where gl_buku.id_buku='$gl_get_id_pasok'");
$gl_sql_report2 = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) join gl_distributor on(gl_buku.id_distributor=gl_distributor.id_distributor) where gl_buku.id_buku='$gl_get_id_pasok'");
}else{
    $gl_sql_report = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) join gl_distributor on(gl_buku.id_distributor=gl_distributor.id_distributor) where gl_detailjual.id_penjualan=''");
$gl_sql_report2 = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) join gl_distributor on(gl_buku.id_distributor=gl_distributor.id_distributor) where gl_detailjual.id_penjualan=''");
}
...
<html>
    <head>
        ...
        <title>Graylabs - Laporan Laba</title>
        <script>
            var i=1;
            function slide(){
                if(i==1){
                    ...
                    <div class="col-md-12" id="content-full2">
                        <div class="rows">
                         ...
                         <div class="report-logo"></div></div>
                                    ...
                                    <div class="col-md-4" id="search2" align="center">
                                        <h4>GRAYLABS BOOK STORE<br>LAPORAN KEUNTUNGAN PENJUALAN<br><span class="small">Jl.Patriot No 11 KM 7.5 MEDAN - SUMATRA UTARA</span></h4>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="rows">
                            <div class="col-md-12">
                                ...
                                <?php echo $gl_r['nama_distributor']; ?>
                            ...
                            <div class="col-md-12" id="report-table">
                                <table class="table table-striped" style="box-shadow:0px 0px 0px 0px;border:solid 1px lightgray;">
                                    ...
                                    if($gl_rows > 0){
                                        ...
                                        $gl_tot_diskon = $gl_fetch['harga_jual']*$gl_fetch['diskon']/100;
                                            $gl_tot_ppn   = $gl_fetch['harga_jual']*$gl_fetch['ppn']/100;
                                            $gl_total = (((($gl_fetch['harga_jual']-$gl_tot_diskon)+$gl_tot_ppn)-$gl_fetch['harga_pokok'])*$gl_fetch['jml_beli']) + $gl_total;
                                     
                                    ?>
                                    <tr>
                                        <td><?php echo $gl_no; ?></td>
                                        <td><?php echo $gl_fetch['id_penjualan']; ?></td>
                                        <td><?php echo $gl_fetch['tanggal']; ?></td>
                                        <td><?php echo $gl_fetch['jml_beli']; ?></td>
                                        
                                        <td align="right" ><?php echo"Rp ".number_format($gl_fetch['harga_pokok'],0,',','.'); ?> </td>
                                        <td align="right"><?php
                                            $gl_diskon = $gl_fetch['harga_jual']*$gl_fetch['diskon']/100;
                                            $gl_ppn   = $gl_fetch['harga_jual']*$gl_fetch['ppn']/100;
                                            echo"Rp ".number_format(($gl_fetch['harga_jual']-$gl_diskon)+$gl_ppn,0,',','.'); ?></td>
                                        <td align="right" ><?php echo"Rp ".number_format($gl_fetch['total_peritem'],0,',','.'); ?> </td>
                                        <td align="right"><?php 
                                            $gl_r_diskon = $gl_fetch['harga_jual']*$gl_fetch['diskon']/100;
                                            $gl_r_ppn   = $gl_fetch['harga_jual']*$gl_fetch['ppn']/100;
                                            echo"Rp ".number_format($gl_r_price = ((($gl_fetch['harga_jual']-$gl_r_diskon)+$gl_r_ppn)-$gl_fetch['harga_pokok'])*$gl_fetch['jml_beli'],0,',','.'); ?></td>
                                    </tr>
                                    <?php
                                            $gl_no++;
                                       }
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="7" align="center" style="border-right:solid 1px lightgray;">TOTAL LABA</td>
