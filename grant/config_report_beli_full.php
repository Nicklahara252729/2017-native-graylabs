...
if(isset($_GET['sch_cari'])){
    ...
    $gl_sql_cari = mysql_query("select * from gl_pasok join gl_detailpasok on (gl_pasok.id_pasok=gl_detailpasok.id_pasok) where gl_pasok.id_pasok like '%$gl_keyword%' order by gl_pasok.id_pasok desc limit $gl_posisi, $gl_limit");
}else{
    $gl_sql_cari = mysql_query("select * from gl_pasok join gl_detailpasok on (gl_pasok.id_pasok=gl_detailpasok.id_pasok) order by gl_pasok.id_pasok desc limit $gl_posisi, $gl_limit");
}
$gl_sql_cord = mysql_query("select * from gl_pasok join gl_detailpasok on (gl_pasok.id_pasok=gl_detailpasok.id_pasok) order by gl_pasok.id_pasok desc limit $gl_posisi, $gl_limit");
                             ...
                             <span class="glyphicon glyphicon-refresh"></span>
                                            ...
                                            <div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu">
                                                    <?php
        $gl_tampil2         = mysql_query("select * from gl_detailpasok");
                    ...
                    <div class="col-md-12" id="content-full">
                       <table class="table table-striped">
                        ...
                        <tr bgcolor="<?php echo $gl_warna; ?>">
                            ...
                            <td><?php echo"Rp ".number_format($gl_fetch['total'],0,',','.'); ?></td>   
                            <td><a href="config_report_beli.php?id_pasok=<?php echo $gl_fetch['id_pasok']; ?>"><button type="button" class="btn" id="green"><span class="glyphicon glyphicon-open-file"></span></button></a></td>
                        </tr>
                        <?php
                                $gl_no++;
                                }
