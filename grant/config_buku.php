...
if(isset($_POST['id_buku'])){
    ...
    $gl_gambar      = $_FILES['gl_gambar_buku']['name']?$_FILES['gl_gambar_buku']['name']:"gl_default.jpg";
...
if(isset($_GET['id_hps_buku'])){
    ...
    $gl_fetch_jml = $gl_fetch_gambar['stok'];
    if($gl_fetch_jml > 0){
        ?>
<script>alert('Buku tidak dapat dihapus ! Dikarenakan sisa stok masih ada');history.back();</script>
<?php
    }else{
...
<html>
    <head>
        ...
        <script>
            ...
            function cek6(){
                var filein6 = document.getElementById('gl_jmlhal').value;
                if(filein6.length >= 0){
