...
<?php
        ...
        $gl_sql_insert = mysql_query("update gl_kasir set nama='$gl_edt_nama', alamat='$gl_edt_alamat', telepon='$gl_edt_telp', status='$gl_edt_status', username='$gl_edt_username', password='$gl_edt_pass', akses='$gl_edt_akses',gambar_kasir='$gl_foto_new' where id_kasir='$gl_id_user'");
        if($gl_sql_insert  && isset($gl_edt_foto)){
            ...
            unlink("pic/mimin/".$gl_fetch_user['gambar_kasir']);
             ...
             $gl_sql_insert = mysql_query("update gl_kasir set nama='$gl_edt_nama', alamat='$gl_edt_alamat', telepon='$gl_edt_telp', status='$gl_edt_status', username='$gl_edt_username', password='$gl_edt_pass', akses='$gl_edt_akses' where id_kasir='$gl_id_user'");
        }
            header("location:config_kasir.php");
    }
    }
}
?>
...
<html>
    <head>
        ...
        <title>Graylabs - Edit User</title>
        <script>
            function cekfile(){
...
<option value="Belum Menikah" <?php echo $gl_fetch_user['status']=='Belum Menikah'?'selected':''; ?>>Belum Menikah</option>
                        ...
                        <div class="col-md-8">
                            <select  name="gl_akses" id="gl_akses" class="col-md-12" >
<option disabled>- Pilih Status -</option>
