                ...
                <div class="rows">
                    ...
                    <div class="col-md-4">
                         <form name="cari" id="cari" enctype="multipart/form-data" method="get" target="_self">
							  <input type="text" class="col-md-10" id="inpt_sch" placeholder="Cari Kode Distributor, Nama" name="sch_cari">
                ...
                <div class="col-md-9" id="right-content">
                    <div class="rows">
                        <div class="col-md-12" id="banner">
                            <span class="glyphicon glyphicon-th-large"></span> &nbsp; Data Supplier
                        </div>
                    </div>
                    <table class="table">
                        <tr>
