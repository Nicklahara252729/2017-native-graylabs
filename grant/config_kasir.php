...
if(isset($_GET['sch_cari'])){
    ...
    $gl_sql_cari = mysql_query("select * from gl_kasir where nama like '%$gl_keyword%' or username like '%$gl_keyword%' order by nama asc limit $gl_posisi, $gl_limit");
    }
}else{
    $gl_sql_cari = mysql_query("select * from gl_kasir  order by nama asc limit $gl_posisi, $gl_limit");
}
                    ...
                    <div class="col-md-7" id="desc-profil">
                        ...
                        <div class="rows">
                            <div class="col-md-12" id="space2">
                                <a href="config_edt_profil.php?id_edt_user=<?php echo $_SESSION['id_kasir']; ?>"><button class="btn btn-warning col-md-12 tip" data-toggle="tooltip" data-placement="bottom" title="Ubah data"><span class="glyphicon glyphicon-edit"></span> &nbsp; Ubah</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="rows">
                    ...
                    <div class="col-md-4">
                         <form name="cari" id="cari" enctype="multipart/form-data" method="get" target="_self">
							  <input type="text" class="col-md-10" id="inpt_sch" placeholder="Cari Nama, Username" name="sch_cari">
                ...
                <div class="col-md-9" id="right-content">
                    <div class="rows">
                        <div class="col-md-12" id="banner">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Data Pegawai
                        </div>
                    </div>
                    <table class="table">
                        <tr>
