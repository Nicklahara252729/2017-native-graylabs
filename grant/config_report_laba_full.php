...
if(isset($_GET['sch_cari'])){
    ...
    $gl_sql_cari = mysql_query("select * from gl_buku join gl_distributor on(gl_buku.id_distributor=gl_distributor.id_distributor) where gl_buku.judul like '%$gl_keyword%' order by gl_buku.judul desc limit $gl_posisi, $gl_limit");
}else{
    $gl_sql_cari = mysql_query("select * from gl_buku join gl_distributor on(gl_buku.id_distributor=gl_distributor.id_distributor) order by gl_buku.judul desc limit $gl_posisi, $gl_limit");
}
$gl_sql_cord = mysql_query("select * from gl_buku order  by gl_buku.judul desc limit $gl_posisi, $gl_limit");
                    ...
                    <div class="col-md-12" id="content-full">
                       <table class="table table-striped">
                        ...
                        <tr bgcolor="<?php echo $gl_warna; ?>">
                            ...
                            <td><a href="config_report_laba.php?id_pasok=<?php echo $gl_fetch['id_buku']; ?>"><button type="button" class="btn" id="green"><span class="glyphicon glyphicon-open-file"></span></button></a></td>
                        </tr>
                        <?php
                                $gl_no++;
                                }
