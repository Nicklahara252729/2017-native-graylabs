...
if(isset($_GET['id_det_user'])){
    $gl_get_id = $_GET['id_det_user'];
...
<html>
    <head>
        ...
        <title>Graylabs - Detail User</title>
    </head>
    <body>
            ...
            <div class="container" id="pro-fil">
                ...
                <div class="rows">
                    ...
                    <div class="col-md-7" id="desc-profil">
                        ...
                        <div class="col-md-8" id="pad-top">
                            : &nbsp; <?php echo $gl_fetch_user['telepon']; ?>
                        </div>
                        </div>
                        <div class="rows">
                        <div class="col-md-1" id="pad-top">
                        ...
                        <div class="col-md-8" id="pad-top">
                            : &nbsp; <?php echo $gl_fetch_user['username']; ?>
                        </div>
                        </div>
                        <div class="rows">
                        <div class="col-md-1" id="pad-top">
                        ...
                        <div class="col-md-8" id="pad-top">
                            : &nbsp; <?php echo $gl_fetch_user['akses']; ?>
                        </div>
                        </div>
                        <div class="rows">
                            <div class="col-md-12" id="space2">
                                <a href="config_edt_user.php?id_edt_user=<?php echo $gl_fetch_user['id_kasir']; ?>"><button class="btn btn-warning col-md-12 tip" data-toggle="tooltip" data-placement="bottom" title="Ubah data"><span class="glyphicon glyphicon-edit"></span> &nbsp; Ubah</button></a>
                            </div>
                        </div>
                    </div>
                </div>
