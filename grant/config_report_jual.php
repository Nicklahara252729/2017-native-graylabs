...
$gl_sql_report = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) where gl_detailjual.id_penjualan='$gl_get_id_pasok'");
$gl_sql_report2 = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) where gl_detailjual.id_penjualan='$gl_get_id_pasok'");
}else{
    $gl_sql_report = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) where gl_detailjual.id_penjualan=''");
$gl_sql_report2 = mysql_query("select * from gl_detailjual join gl_penjualan on (gl_detailjual.id_penjualan=gl_penjualan.id_penjualan) join gl_buku on (gl_detailjual.id_buku=gl_buku.id_buku) join gl_kasir on (gl_penjualan.id_kasir=gl_kasir.id_kasir) where gl_detailjual.id_penjualan=''");
}
                    ...
                    <div class="col-md-12" id="content-full2">
                        <div class="rows">
                         ...
                         <div class="report-logo"></div></div>
                                    ...
                                    <div class="col-md-4" id="search2" align="center">
                                        <h4>GRAYLABS BOOK STORE<br>LAPORAN PENJUALAN BUKU<br><span class="small">Jl.Patriot No 11 KM 7.5 MEDAN - SUMATRA UTARA</span></h4>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="rows">
                            <div class="col-md-12">
                                ...
                                <?php echo $gl_r['id_penjualan']; ?></div>
                            </div>
                        </div>
                        <div class="rows">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12" id="report-table">
                                <table class="table table-striped" style="box-shadow:0px 0px 0px 0px;border:solid 1px lightgray;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><?php echo $gl_fetch['ppn']; ?> %</td>
                                        <td style="text-align:center;"><?php echo $gl_fetch['diskon']; ?> %</td>
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="7" align="center" style="border-right:solid 1px lightgray;">TOTAL SELURUH</td>
