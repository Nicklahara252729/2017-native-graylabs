...
if(isset($_GET['sch_cari'])){
    ...
    $gl_sql_cari = mysql_query("select * from gl_penjualan join gl_detailjual on (gl_penjualan.id_penjualan=gl_detailjual.id_penjualan) where gl_penjualan.id_penjualan like '%$gl_keyword%' order by gl_penjualan.id_penjualan desc limit $gl_posisi, $gl_limit");
}else{
    $gl_sql_cari = mysql_query("select * from gl_penjualan join gl_detailjual on (gl_penjualan.id_penjualan=gl_detailjual.id_penjualan) order by gl_penjualan.id_penjualan desc limit $gl_posisi, $gl_limit");
}
$gl_sql_cord = mysql_query("select * from gl_penjualan join gl_detailjual on (gl_penjualan.id_penjualan=gl_detailjual.id_penjualan) order by gl_penjualan.id_penjualan desc limit $gl_posisi, $gl_limit");
                            ...
                            <div class="col-md-12">
                                <div class="rows">
                                    <div class="col-md-4" id="pad-top2">
                                        <div class="rows">
                         <div class="col-md-2 tip" data-toggle="tooltip" data-placement="bottom" id="tambah" title="Data Transaksi" onclick="location.href='config_transaksi.php'">
                             ...
                             <span class="glyphicon glyphicon-refresh"></span>
                                            ...
                                            <div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu">
                                                    <?php
        $gl_tampil2         = mysql_query("select * from gl_detailjual");
                    ...
                    <div class="col-md-12" id="content-full">
                       <table class="table table-striped">
                        ...
                        <tr bgcolor="<?php echo $gl_warna; ?>">
                            ...
                            <td><?php echo"Rp ".number_format($gl_fetch['jumlah'],0,',','.'); ?></td>   
                            <td><a href="config_report_jual.php?id_pasok=<?php echo $gl_fetch['id_penjualan']; ?>"><button type="button" class="btn" id="green"><span class="glyphicon glyphicon-open-file"></span></button></a></td>
                        </tr>
                        <?php
                                $gl_no++;
                                }
